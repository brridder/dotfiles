...
config.keys = {
  {
    key = 'd',
    mods = 'CMD',
    action = wezterm.action.SplitPane { direction = 'Right', top_level = false, size = { Percent = 50} },
  },
  {
    key = 'd',
    mods = 'CMD|SHIFT',
    --action = wezterm.action.SplitVertical { domain = 'CurrentPaneDomain' },
    action = wezterm.action.SplitPane { direction = 'Down', top_level = false, size = { Percent = 50} },
  },
  {
    key = 'w',
    mods = 'CMD',
